...
\section{Projects}
\resumeSubHeadingListStart
\resumeSubItem{Amalgom}{Developed an efficient voxel game engine for the web and native using Rust and WebGPU}
\resumeSubItem{QALC (Quantum Calculator)}{A Bra-Ket notation based language compiler built with MLIR and LLVM in C++}
\resumeSubItem{Distributed Ledger}{Contributed to and applied a Rust distributed ledger for peer to peer video game networking}
...
\resumeSubItem{GPU Iter}{Built a Rust GPU compute library that focussed on usability and efficiency}
\resumeSubItem{Beer Money}{Co-founded an LLC and launched an odd jobs marketplace app \& website for students built with Elixir}
\resumeSubHeadingListEnd
...
\resumeSubItem{General Experience}{Git, Docker, Unix, Agile Processes, Compilers, Deep Learning, Graphics, Quantum Computing}
\resumeSubHeadingListEnd
