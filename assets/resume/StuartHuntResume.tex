...
\resumeSubItem{Minecraft Plugins}{Helped develop the Java plugins for the book \emph{Learn to Program with Minecraft Plugins}}
\resumeSubHeadingListEnd
...
{Rust -- Java -- C -- C\# -- C++ -- Go -- Python -- Ruby -- Typescript/Javascript -- HTML/CSS -- Elixir}
