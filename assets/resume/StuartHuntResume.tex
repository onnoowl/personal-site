...
I am a software developer with years of diverse experience in full stack development, backend, frontend, web, computer graphics, game engines, deep learning, and quantum computing. I am seeking a position in prototyping or product development (remote, or local in Raleigh/Durham/RTP) that will fuel my passion for innovation, and make effective use of my diverse technical background in software.
...
\section{Projects}
\resumeSubHeadingListStart
\resumeSubItem{Amalgom}{Architected \& built a voxel game engine using Rust \& WebGPU with 42x the render distance as Minecraft}
\resumeSubItem{QALC (Quantum Calculator)}{A Bra-Ket notation based language compiler built with MLIR and LLVM in C++}
\resumeSubItem{Distributed Ledger}{Contributed to a Rust distributed ledger for use in a prototype peer to peer video game network}
...
\resumeSubItem{Beer Money}{Co-founded an LLC and launched a full stack odd jobs marketplace app \& website built with Elixir}
\resumeSubHeadingListEnd
